    ...
    <div>
        <Head>
         ...
         <header className="mx-auto max-w-xl">
            <Link href="/">
                <div className="relative ml-4 h-12 w-12 cursor-pointer transition lg:hidden">
                    <Image
                    src="https://i.ibb.co/qNZ0xZQ/images-removebg-preview.png"
                    layout="fill"
                    objectFit="contain"
                    />
                </div>
          ...
          <div className="mx-4 divide-y divide-gray-300 rounded-md border border-gray-300 p-4 lg:ml-14">
            <div className="space-y-2 pb-3">
              ...
              <p className="text-sm text-gray-600">
               We have accepted your order, and we are getting it ready. Come back
